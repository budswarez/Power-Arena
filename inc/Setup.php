...
final class Setup {
    ...
    public static function menusAndSizes(): void {
        ...
        // Cards compactos de 64px eram obrigados a baixar a menor variante
        // disponível de 300px. 240px cobre telas de alta densidade sem enviar
        // 25-30 KiB para um slot visual de 64x48px.
        add_image_size('arena-card-small', 240, 135, true);
        // Candidate intermediário para cards em telas mobile/retina. O
        // `arena-card` continua sendo a imagem canônica dos templates; o core
        // inclui este arquivo de 480 px no `srcset` por compartilhar a mesma
        // proporção 16:9, evitando baixar 760 px para um slot de ~322 px.
        add_image_size('arena-card-mobile', 480, 270, true);

        // O banner da home tem proporção 10:3. WPBakery renderiza o tamanho
        // `full`, mas Performance::responsiveVcSingleImage() acrescenta o
        // srcset do anexo; esta variante atende o slot mobile sem transferir a
        // arte de 1170 px.
        add_image_size('arena-banner-mobile', 640, 192, true);
    }
