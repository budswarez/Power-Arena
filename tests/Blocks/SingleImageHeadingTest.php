...
class SingleImageHeadingTest extends WP_UnitTestCase {
    public function test_filter_title_rewrites_singleimage_heading_into_bar_and_text_spans(): void {
        $html = SingleImageHeading::filterTitle(
            '<h2 class="wpb_heading wpb_singleimage_heading">Evento Pichau Arena 2026</h2>',
            ['title' => 'Evento Pichau Arena 2026', 'extraclass' => 'wpb_singleimage_heading']
        );
        ...
        $this->assertStringContainsString('Evento Pichau Arena 2026', $html);
