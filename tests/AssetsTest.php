...
class AssetsTest extends WP_UnitTestCase {
    ...
    public function test_card_sizes_match_compact_and_list_layouts(): void {
        $this->assertSame('64px', Assets::cardSizes('text'));
        $this->assertSame('(max-width: 600px) calc(100vw - 30px), 210px', Assets::cardSizes('list-blog'));
        $this->assertSame('(max-width: 768px) calc(100vw - 30px), 300px', Assets::cardSizes('list-archive'));
    }
    ...
    public function test_card_context_detects_compact_and_list_classes(): void {
        $this->assertSame('text', Assets::cardContext('attachment-arena-card arena-card-context-text'));
        $this->assertSame('list-blog', Assets::cardContext('attachment-arena-card arena-card-context-list-blog'));
        $this->assertSame('list-archive', Assets::cardContext('attachment-arena-card arena-card-context-list-archive'));
    }
