...
class SetupTest extends WP_UnitTestCase {
    public function test_registers_responsive_card_and_banner_image_sizes(): void {
        global $_wp_additional_image_sizes;

        Setup::menusAndSizes();

        $this->assertSame(
            ['width' => 240, 'height' => 135, 'crop' => true],
            $_wp_additional_image_sizes['arena-card-small'] ?? null
        );
        $this->assertSame(
            ['width' => 480, 'height' => 270, 'crop' => true],
            $_wp_additional_image_sizes['arena-card-mobile'] ?? null
        );
        $this->assertSame(
            ['width' => 640, 'height' => 192, 'crop' => true],
            $_wp_additional_image_sizes['arena-banner-mobile'] ?? null
        );
    }
