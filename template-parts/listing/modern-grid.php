...
if ($query->have_posts()) {
    while ($query->have_posts()) {
        ...
        get_template_part('template-parts/card/hero', null, [
            'is_first' => $index === 1,
            // No mobile os dois tiles grandes da primeira linha têm a mesma
            // área e ambos podem ser eleitos LCP. O PSI de 01/08 escolheu o
            // segundo, que antes ficava em prioridade "auto". Concentramos
            // high nos dois candidatos reais, sem promovê-lo nos compactos.
            'high_priority' => $blocoAcimaDaDobra && $index <= $firstRowSize,
