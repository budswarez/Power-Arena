 ...
 * `.post-meta` + `.post-summary` SEO description (with excerpt fallback).
...
<article <?php post_class('listing-item ' . $wrapperClass); ?>>
    <div class="item-inner clearfix">
        <div class="<?php echo esc_attr($featuredClass); ?>">
            ...
            <?php if ($showThumb): ?>
                <a class="img-holder" href="<?php echo esc_url($permalink); ?>">
                    <?php
                    $imgAttr = [
                        'class'    => 'attachment-arena-card arena-card-context-list-' . $variant,
                        'decoding' => 'async',
        ...
        <div class="content-container">
            ...
            <?php if ($showExcerpt): ?>
                <div class="post-summary"><?php echo wp_kses_post(\Arena\Seo::postDescription((int) $postId)); ?></div>
            <?php endif; ?>
        </div>
    </div>
</article>
