...
**Files:**
- Create: `docs/superpowers/recon/2026-07-24-powerarenaarena-findings.md`
...
Preencher `docs/superpowers/recon/2026-07-24-powerarenaarena-findings.md` com: versão WP/PHP em produção, tema ativo, contagem/lista de conteúdos com `[bs-*]` (e se a home é um deles), plugins ativos com versão, estrutura completa dos menus, e observações de tokens visuais (cores/fontes vistas no CSS servido). **Este arquivo é a entrada do Plano 2.**
...
Run:
```bash
wp-env run cli wp search-replace 'https://www.powerarena.example.com' 'http://localhost:8888' --all-tables --precise
```
...
/*
Theme Name: Arena
Theme URI: https://www.powerarena.example.com/
Author: Power Arena
