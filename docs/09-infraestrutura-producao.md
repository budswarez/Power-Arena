...
O `powerarena.example.com` roda numa **hospedagem gerenciada da Hostinger**, numa
...
`https://www.powerarena.example.com`, **antes de o PHP rodar**.

Ele existe porque requisições em `http://powerarena.example.com` chegavam ao PHP e
